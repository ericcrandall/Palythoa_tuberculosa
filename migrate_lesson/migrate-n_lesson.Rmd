...
usertree=RANDOMTREE
infile=../panpen_CI_Iacchei.txt
random-seed=AUTO
title=panpen_CI_Iacchei
progress=YES
logfile=NO
print-data=NO
outfile=panpen_CI_Iacchei_outfile.txt
pdf-outfile=panpen_CI_Iacchei_outfile.pdf
...
12. When all runs are complete, download the entire folder thusly:
...
13. Now we will rank the models based on their marginal likelihood scores. This script will rip through all of the output files, and harvest the marginal likelihood scores
...
![GGMCMC Plots for P. coelestis](../figures/pcoelestis_ggmcmc.pdf)
